...
store="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_STORE:-$fixture_root/analysis.zarr}"
receipt="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_RECEIPT:-$fixture_root/result.json}"
receipt_sha256="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_RECEIPT_SHA256:-8ccd4b1ce19e1ad632d48b8ef16dbbc2eb963170561a3fb4232dc944a6810a96}"
bundle="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_BUNDLE:-subject_mask_bundle_sleepyfish_composable_modern_receipts_20260811_e523c816_v1}"
bundle_digest="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_BUNDLE_DIGEST:-1404538de8e53503dbc39449ca9a3d2e60ba1e0cb71d7c54e3da7d062ecccc7f}"
refined_run="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_REFINED_RUN:-refined_subject_masks_sleepyfish_composable_modern_receipts_20260811_e523c816_v1}"
refined_digest="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_REFINED_DIGEST:-97ae241d3860031a03f02fb7b541060cb03b0bb8c7e3c50eeadfeb039ce1fa45}"
cache_run="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_CACHE_RUN:-subject_mask_sampled_contours_sleepyfish_composable_modern_receipts_20260811_e523c816_v1}"
cache_digest="${CRIMSON_SUBJECT_MASK_BUNDLE_V4_CACHE_DIGEST:-844cd75cf13d6a3d1ab6ba43ebf7f885acb2c93181916b4acbb3c80fb3251fe6}"
