...
Build options:
  ...
  --bundle-runtime-closure  Bundle the resolved non-platform transitive
                            shared-library closure into the app drop.
...
append_switch build_args --bundle-runtime-closure "$bundle_runtime_closure"
